...
function incsub_sbe_include_templates_files() {
	include_once( INCSUB_SBE_PLUGIN_DIR . 'inc/mail-templates/class-sbe-digest-sender.php' );
	include_once( INCSUB_SBE_PLUGIN_DIR . 'inc/mail-templates/abstract-class-sbe-template.php' );
