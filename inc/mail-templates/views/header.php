...
<div style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif !important;">
	<table style="width: 100%;" bgcolor="<?php echo sbe_get_header_color(); ?>">
		<tbody>
			<tr>
				<td></td>
								...
								<tr>
									...
									<td align="right">
										<?php if ( sbe_display_blog_name() ): ?>
											<h6><a style="text-decoration:none !important; margin: 0 !important; padding:0;font-weight: 900; font-size: 14px; text-transform: uppercase; color: <?php echo sbe_get_header_text_color(); ?> !important;" href="<?php echo get_home_url(); ?>"><?php echo sbe_get_from_sender(); ?></a></h6>
										<?php endif; ?>
									</td>
								</tr>
							</tbody>
